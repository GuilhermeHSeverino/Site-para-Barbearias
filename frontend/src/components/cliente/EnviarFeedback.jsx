...
function EnviarFeedback() {
  ...
  const [nota, setNota] = useState(5); // sua API permite de 1 a 10

  useEffect(() => {
    api.get("/api/v1/barber/", ACCESS_TOKEN)
  ...
  return (
    <div className="container mt-4 text-white">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <button type="submit" className="btn btn-success">Enviar Feedback</button>
      </form>
    </div>
  );
}
